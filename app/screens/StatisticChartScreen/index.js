...
class StatisticChartScreen extends Component {
   ...
   renderLostedFollowersChart() {
      if (this.state.ShouldrenderFollowerChart === true && this.props.lostedFetching === false) {
         if (this.props.lostedErrorFlag === false) {
            return (
               <View
         ...
         if (this.lostedHeight === 0) {
            this.lostedHeight = 432
         }
         return (
            <View
               style={{
   ...
   renderGainedFollowersChart() {
      if (this.state.ShouldrenderFollowerChart === true && this.props.gainedFetching === false) {
         if (this.props.gainedErrorFlag === false) {
            return (
               <View
                  style={styles.chartContainer}
                  onLayout={event => {
               ...
               >
                  ...
                  >
                     ...
                     <VictoryAxis
                        ...
                        tickFormat={x => {
                           if (Number.isInteger(x)) {
                              const month = this.props.gainedData.month[x - 1]
                              const day = this.props.gainedData.day[x - 1]
                              switch (month) {
                                 case 1: {
                                    return day + " Jan"
                                 }
         ...
         if (this.gainedHeight === 0) {
            this.gainedHeight = 432
         }
         return (
            <View
               style={{
   ...
   renderFollowerChart() {
      if (this.state.ShouldrenderFollowerChart === true && this.props.followersFetching === false) {
         if (this.props.followersErrorFlag === false) {
            return (
               <View
                  style={styles.chartContainer}
                  onLayout={event => {
         ...
         if (this.followerHeight === 0) {
            this.followerHeight = 432
         }
         return (
            <View
               style={{
